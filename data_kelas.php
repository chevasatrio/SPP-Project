...
<table class="table table-hover table-striped">
    ...
    <tr>              
        ...
        <td><a href="hapus_data_kelas.php?id_kelas=<?=$data_kelas['id_kelas']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
...
<a href="tambah_data_kelas.php" class="btn btn-info">Tambah Kelas</a>
